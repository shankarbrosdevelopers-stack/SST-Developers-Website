...
const FEATURED_PROPERTIES: Property[] = [
  { id: 1, title: 'Luxury 3BHK Duplex', price: '₹60 Lakhs', location: 'Bhubaneswar', type: 'Duplex', beds: 3, baths: 3, sqft: 1800, image: 'https://picsum.photos/id/12/600/400' },
  { id: 2, title: 'Grand Royal Mansion', price: '₹1.89 Cr', location: 'Bhubaneswar', type: 'Mansion', beds: 5, baths: 5, sqft: 4500, image: 'https://picsum.photos/id/28/600/400' },
  { id: 3, title: 'Premium 4BHK Villa', price: '₹85 Lakhs', location: 'Bhubaneswar', type: 'Villa', beds: 4, baths: 4, sqft: 2400, image: 'https://picsum.photos/id/188/600/400' },
  { id: 4, title: 'Modern Duplex Home', price: '₹75 Lakhs', location: 'Bhubaneswar', type: 'Duplex', beds: 3, baths: 3, sqft: 2000, image: 'https://picsum.photos/id/164/600/400' },
  { id: 5, title: 'Elite 4BHK Estate', price: '₹1.05 Cr', location: 'Bhubaneswar', type: 'Villa', beds: 4, baths: 4, sqft: 2800, image: 'https://picsum.photos/id/221/600/400' },
  { id: 6, title: 'Signature Mansion', price: '₹1.89 Cr', location: 'Bhubaneswar', type: 'Mansion', beds: 6, baths: 6, sqft: 5000, image: 'https://picsum.photos/id/235/600/400' },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {FEATURED_PROPERTIES.map((prop) => (
            <div key={prop.id} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
  ...
  return (
    <section id="categories" className="py-16 bg-white">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-serif font-bold text-slate-800 mb-12">Browse By Category</h2>
