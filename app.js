...
const icons = {
    ...
    heart: `<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"></path></svg>`,
    google: `<svg viewBox="0 0 24 24" width="20" height="20"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.32 1.67-1.27 3.09-2.67 4.04v3.35h4.31c2.53-2.33 3.99-5.76 3.99-9.39z"/><path fill="#34A853" d="M12 23c3.11 0 5.71-1.03 7.61-2.78l-4.31-3.35c-1.19.8-2.72 1.28-4.3 1.28-3.31 0-6.13-2.23-7.14-5.23H.52v3.47A11.996 11.996 0 0 0 12 23z"/><path fill="#FBBC05" d="M4.86 12.91c-.26-.78-.4-1.61-.4-2.46s.14-1.68.4-2.46V4.51H.52C-.19 5.92-.76 7.42-.76 9s.57 3.08 1.28 4.49l3.34-2.58z"/><path fill="#EA4335" d="M12 4.49c1.69 0 3.2.58 4.39 1.72l3.3-3.3C17.69 1.03 15.11 0 12 0 7.42 0 3.48 2.66 1.76 6.5l3.1.58C5.52 4.26 8.5 2.01 12 2.01z"/></svg>`,
